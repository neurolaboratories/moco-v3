...
parser.add_argument('--save-interval',
                    ...
                    type=int,
                    metavar='N',
                    help='epoch save interval (default: 20)')
...
parser.add_argument('--moco-mlp-dim',
                    default=4096,
                    type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.optimizer == 'lars':
        optimizer = moco.optimizer.LARS(model.parameters(),
                                        args.lr,
            ...
            if epoch % args.save_interval == 0:
                save_checkpoint(
                    ...
                    filename=str(
                        ...
                        'checkpoint_{0}.pth.tar'.format(epoch)))
    if args.rank == 0:
...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    if epoch < args.warmup_epochs:
        ...
        lr = args.lr * 0.5 * (1. +
                              math.cos(math.pi * (epoch - args.warmup_epochs) /
